...
*"The product isn't the scanner. The product isn't the manifest. The product is: a developer opens a PR, sees a comment, clicks a link, clicks Confirm, and the check goes green. That's it. Everything else is infrastructure in service of those five steps."*
